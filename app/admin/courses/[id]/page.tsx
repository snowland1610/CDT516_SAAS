...
export default function AdminCourseDetailPage() {
  ...
  const [studentsBySection, setStudentsBySection] = useState<Record<number, { name: string; student_no: string }[]>>({})
  ...
  if (error || !course) {
    return (
      <div>
        ...
        <Link href="/admin/courses" className="text-primary hover:text-primary-hover text-sm transition-colors">
          ← 返回课程目录
        </Link>
      </div>
    )
